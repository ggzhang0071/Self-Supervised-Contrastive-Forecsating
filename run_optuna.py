...
def main():
    def main(trial):
        ...
        # AutoCon config
        parser.add_argument('--AutoCon', action='store_true', default=False, help='')
        parser.add_argument('--AutoCon_wnorm', type=str, default='LastVal', help='Window Normalization Techniques: {ReVIN | Mean | LastVal | Decomp}')

        parser.add_argument('--AutoCon_lambda', type=float, default=1.0, help='')
        parser.add_argument('--AutoCon_multiscales', type=int, nargs='+', default=[96], help='e.g., [96, 192], [96, 192, 720]')
